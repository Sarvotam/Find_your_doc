...
=beginpatient1 = User.create!(email: "patient1@gmail.com", username: "Patient1", first_name: "Patient1", Last_name: "suwal", date_of_birth: "02-04-2001", user_type: 1, password: "patient1", contact_number: 34234324, gender: 0, address: "Bhaktapur")
...
Appointment.create!(user_id: patient2.id, doctor_id: doc2.id, health_history: "weaker")=end
