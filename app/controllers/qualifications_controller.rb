class QualificationsController < ApplicationController
  ...
  def create
    ...
    @qualification.doctor_id = current_user.doctor.id
  ...
  private
    ...
    def qualification_params
      params.require(:qualification).permit(:qualification_name, :institute_name, :language, :board_certification, :procurement_year )
    end
